...
$config['openai.settings']['api_org'] = $_ENV['OPENAI_API_ORG'];
// Pixabay API key.
$config['media_pixabay.admin.config']['media_pixabay_api'] = $_ENV['PIXABAY_API_KEY'];
// DeepL Free Auth key
$config['tmgmt.translator.deepl_free']['settings']['auth_key'] = $_ENV['DEEPL_FREE_AUTH_KEY'];
